...
class Lesson15Screen extends StatefulWidget {
  const Lesson15Screen({super.key});
                                  ...
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              "Let’s get you familiarized with the vocabulary related to this.",
                                        ),
                                      ],
                                    ),
                                  ),
                                ...
                                builder: (BuildContext context,
                                  ...
                                  return Column(
                                    children: [
                                      ...
                                      // Question 2
                                      Text(
                                        '2. Based on the video below, what date is the person’s birthday?',
                                        textAlign: TextAlign.justify,
                                        style: TextStyle(
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold),
